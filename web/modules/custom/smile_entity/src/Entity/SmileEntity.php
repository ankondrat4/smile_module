 ...
 *     "list_builder" = "Drupal\smile_entity\Entity\Controller\SmileEntityListBuilder",
 *     "form" = {
...
class SmileEntity extends ContentEntityBase implements SmileEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the Record.'))
      ->setReadOnly(TRUE);

    // Name field for the title.
    $fields['title'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Title'))
      ->setDescription(t('The title of the record.'))
      ->setSettings([
        'max_length' => 255,
        'text_processing' => 0,
      ])
    ...
    $fields['body'] = BaseFieldDefinition::create('text_long')
      ->setLabel(t('Body'))
      ->setDescription(t('The body of the record.'))
      ->setSettings([
        'max_length' => 1024,
        'text_processing' => 0,
      ])
