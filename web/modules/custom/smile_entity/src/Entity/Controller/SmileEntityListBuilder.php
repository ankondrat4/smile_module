...
class SmileEntityListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new SmileEntityListBuilder object.
   *
  ...
  public function render() {
    $build['description'] = [
      '#markup' => $this->t('Smile Entity implements example Content Entity.
         Manage the fields on the <a href="@adminlink">Admin page</a>.', [
   ...
   * {@inheritdoc}
   *
   * Building the header and content lines for the smile entity list.
   *
  ...
  public function buildRow(EntityInterface $entity) {
    /* @var $entity \Drupal\smile_entity\Entity\SmileEntity */
    $row['id'] = $entity->id();
