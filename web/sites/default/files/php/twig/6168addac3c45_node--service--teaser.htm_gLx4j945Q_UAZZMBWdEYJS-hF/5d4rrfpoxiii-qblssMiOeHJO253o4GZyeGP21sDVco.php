...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 8, $this->source)))) : (""))];
  ...
  ";
      ...
      ";
            // line 21
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_upper_filter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(($context["label"] ?? null), 21, $this->source))), "html", null, true);
            echo "
    </h1>
  ";
        }
...
", "themes/custom/my_theme/templates/node--service--teaser.html.twig", "/var/www/domain2.com/web/themes/custom/my_theme/templates/node--service--teaser.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("clean_class" => 4, "escape" => 15, "upper" => 21, "render" => 21, "striptags" => 27, "length" => 28, "slice" => 28);
        static $functions = array();

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if'],
                ['clean_class', 'escape', 'upper', 'render', 'striptags', 'length', 'slice'],
                []
            );
