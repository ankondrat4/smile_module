...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 8, $this->source)))) : (""))];
  ...
  <div";
    ...
    ";
        ...
        // line 34
        echo "    ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (((twig_length_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["summary"] ?? null), 34, $this->source)) > 100)) ? ((twig_slice($this->env, $this->sandbox->ensureToStringAllowed(($context["summary"] ?? null), 34, $this->source), 0, 200) . "...")) : (($context["summary"] ?? null))), "html", null, true);
        echo "
  </div>
