...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 8, $this->source)))) : (""))];
  ...
  <div";
    ...
    ";
        ...
        // line 19
        echo "    ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (((twig_length_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["summary"] ?? null), 19, $this->source)) > 100)) ? ((twig_slice($this->env, $this->sandbox->ensureToStringAllowed(($context["summary"] ?? null), 19, $this->source), 0, 100) . "...")) : (($context["summary"] ?? null))), "html", null, true);
        echo "
  ...
  <div>
    <div >";
        // line 25
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_term", [], "any", false, false, true, 25), 25, $this->source), "html", null, true);
        echo "</div><br>
  </div>
  <div>
    <div><a class=\"b\"  href=\"";
        ...
        echo "\" rel=\"bookmark\">";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_title", [], "any", false, false, true, 28), 28, $this->source), "html", null, true);
        echo "</a></div><br>
  </div>
  <div>
    <div class=\"c\">";
        // line 31
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_subtitle", [], "any", false, false, true, 31), 31, $this->source), "html", null, true);
        echo "</div><br>
  </div>
  <div>
    <div><a class=\"d\"  href=\"";
...
";
    ...
    {
        return array (  97 => 38,  91 => 34,  85 => 31,  77 => 28,  71 => 25,  61 => 19,  59 => 18,  55 => 17,  50 => 15,  46 => 13,  44 => 8,  43 => 7,  42 => 6,  41 => 5,  40 => 4,  39 => 2,);
    }
