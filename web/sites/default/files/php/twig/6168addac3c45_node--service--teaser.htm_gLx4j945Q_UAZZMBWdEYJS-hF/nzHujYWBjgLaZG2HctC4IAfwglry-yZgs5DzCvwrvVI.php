...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 8, $this->source)))) : (""))];
  ...
  <div>
    <div >";
        // line 19
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_tags2", [], "any", false, false, true, 19), 19, $this->source), "html", null, true);
        echo "</div><br>
  </div>
  <div>
    <div><a class=\"b\"  href=\"";
...
";
    ...
    {
        return array (  83 => 32,  77 => 28,  71 => 25,  63 => 22,  57 => 19,  50 => 15,  46 => 13,  44 => 8,  43 => 7,  42 => 6,  41 => 5,  40 => 4,  39 => 2,);
    }
